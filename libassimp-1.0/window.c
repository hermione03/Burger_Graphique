...
/*!\brief identifiant de la scene générée par assimpGenScene */
static GLuint _id_scene_2 = 0;
/*!\brief identifiant de la scene générée par assimpGenScene */
static GLuint _id_scene_3 = 0;
/*!\brief identifiant de la scene générée par assimpGenScene */
static GLuint _id_scene_4 = 0;
/*!\brief identifiant de la scene générée par assimpGenScene */
static GLuint _id_scene_5 = 0;
/*!\brief identifiant de la scene générée par assimpGenScene */
static GLuint _id_scene_6 = 0;
...
int main(int argc, char **argv)
{
  ...
  if (!gl4duwCreateWindow(argc, argv, "GL4Dummies", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
    ...
    return 1;
  _id_scene = assimpGenScene("models/models/Burger/pain_2.fbx");
  _id_scene_2 = assimpGenScene("models/models/Burger/frommage.fbx");
  _id_scene_3 = assimpGenScene("models/models/Burger/tommates.fbx");
  _id_scene_4 = assimpGenScene("models/models/Burger/steak.fbx");
  _id_scene_5 = assimpGenScene("models/models/Burger/salade.fbx");
  _id_scene_6 = assimpGenScene("models/models/Burger/pain_1.fbx");
  initGL();
  atexit(quit);
...
static void draw(void)
{
  ...
  // Dessinez la première scène
  gl4duTranslatef(0, 0.5, -1.0);
  assimpDrawScene(_id_scene);

  // Revenez à la position initiale de la caméra
  gl4duLoadIdentityf();
  gl4duLookAtf(_cam.x, _cam.y, _cam.z,
               _cam.x - sin(_cam.theta), _cam.y, _cam.z - cos(_cam.theta),
               0.0, 1.0, 0.0);

  // Déplacez la caméra et dessinez la deuxième scène
  gl4duTranslatef(0, 0.2, -1.0);
  assimpDrawScene(_id_scene_2);
  ...
  // Déplacez la caméra et dessinez la troisième scène
  gl4duTranslatef(0, 0.22, -1.0);
  assimpDrawScene(_id_scene_3);
  // Revenez à la position initiale de la caméra
  gl4duLoadIdentityf();
  gl4duLookAtf(_cam.x, _cam.y, _cam.z,
               _cam.x - sin(_cam.theta), _cam.y, _cam.z - cos(_cam.theta),
  ...
  // Déplacez la caméra et dessinez la troisième scène
  gl4duTranslatef(0, 0.1, -1.0);
  assimpDrawScene(_id_scene_4);
  // Revenez à la position initiale de la caméra
  gl4duLoadIdentityf();
  gl4duLookAtf(_cam.x, _cam.y, _cam.z,
               _cam.x - sin(_cam.theta), _cam.y, _cam.z - cos(_cam.theta),
  ...
  // Déplacez la caméra et dessinez la troisième scène
  gl4duTranslatef(0, 0.0, -1.0);
  assimpDrawScene(_id_scene_5);
  // Revenez à la position initiale de la caméra
  gl4duLoadIdentityf();
  gl4duLookAtf(_cam.x, _cam.y, _cam.z,
               _cam.x - sin(_cam.theta), _cam.y, _cam.z - cos(_cam.theta),
