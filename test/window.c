...
static GL4DHanime _animations[] = {
    ...
    {5000, texte_intro, NULL, NULL},
    {2000, texte_intro, texte_2, fondui},
    {3000, texte_2, NULL, NULL},
    {2000, texte_2, model, fondu},
    {10000, model, NULL, NULL},
    {2000, model, credits, fondu},
    {10000, credits, NULL, NULL},

    // {2000, vert, nmap, fondu},
    // {10000, nmap, NULL, NULL},

    // {5000, nmap, spectre, fondu},
...
{
  if (!gl4duwCreateWindow(argc, argv, "Projet Maria ",
